...
public class SignUpThree extends JFrame implements ActionListener{
    ...
    SignUpThree(String formno){
        ...
        type.setBounds(100,80,300,30);
        add(type);
        
        r1=new JRadioButton("Savinng Account");
        r1.setFont(new Font("Raleway",Font.BOLD,16));
        r1.setBackground(Color.WHITE);
        r1.setBounds(100,120,190,20);
        add(r1);
        
        r2=new JRadioButton("Fixed Deposit Account");
        r2.setFont(new Font("Raleway",Font.BOLD,16));
        r2.setBackground(Color.WHITE);
        r2.setBounds(350,120,210,20);
        add(r2);
        
        r3=new JRadioButton("Current Account");
        r3.setFont(new Font("Raleway",Font.BOLD,16));
        r3.setBackground(Color.WHITE);
        r3.setBounds(100,160,190,20);
        add(r3);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==submit){
            ...
            if(r1.isSelected()){
                ...
                accountType="Fixes Deposit Account";
            ...
            try{
                if (accountType.equals("")){
                    ...
                    JOptionPane.showMessageDialog(null, "Crad Number"+ cardnumber+"\n Pin:"+pinnumber);
